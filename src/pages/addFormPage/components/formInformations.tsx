        ...
        <div className="grid">
          <div className="flex justify-around">
            <div className="w-full p-6">
              <h1 className="text-3xl text-[#243B67] pb-3 font-sans">Form title</h1>
              <input
              ...
              />
              <label className="block mb-2 text-sm font-medium text-[#243B67] pt-6 font-sans">
                Description
              </label>
              <input
                ...
                type="text"
                id="description"
                className="bg-gray-50 border border-gray-300 text-[#243B67] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 h-[80px] font-sans"
