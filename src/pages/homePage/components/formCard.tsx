...
const FormCard: FC<FormProps> = ({ form, index }) => {
  ...
  return (
    <div className="w-full max-w-sm bg-[#F3F3F3] border border-gray-200 shadow-md mt-5 mr-5 ">
      <div className="flex justify-end px-4 pt-4">
        ...
        >
          <ul className="py-1" aria-labelledby="dropdownButton">
            <li>
              <div
                onClick={() => navigate("/editForm", { state: form })}
      ...
      <div className="flex flex-col items-center pb-10">
        <h5 className="mb-1 text-xl font-medium text-black font-sans">
          {form.title}
        </h5>
